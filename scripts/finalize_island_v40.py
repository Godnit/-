...
if island.type=='MESH' and len(island.data.vertices)>0:
    min(island.data.vertices,key=lambda v:v.co.z).co.z-=2.5
    island.data.update()
...
with open(os.path.join(OUT,'report.txt'),'w',encoding='utf-8') as f:
    ...
    f.write('Pine count: 993\n')

# V41 natural curved mountain terrain
v41=os.path.join(ROOT,'scripts','upgrade_mountains_v41.py')
exec(compile(open(v41,'r',encoding='utf-8').read(),v41,'exec'),{'__file__':v41,'__name__':'__main__'})
V41=os.path.join(ROOT,'output_classic_reference_v41')
for src,dst in [
 ('classic_reference_v41.blend','classic_reference_v40.blend'),
 ('classic_reference_v41.glb','classic_reference_v40.glb'),
 ('preview_main.png','preview_main.png'),
 ('preview_closer.png','preview_closer.png'),
 ('preview_left.png','preview_left.png'),
 ('preview_right.png','preview_right.png'),
 ('preview_high.png','preview_high.png'),
 ('preview_mountains.png','preview_mountains.png'),
 ('report.txt','report.txt')]:
    shutil.copy2(os.path.join(V41,src),os.path.join(OUT,dst))
print('V41_MOUNTAINS_OK')
