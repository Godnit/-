...
## CI
GitHub Actions first generates a small low-poly portal asset with Blender, cleans inherited legacy files from the CI workspace, then exports the Android APK. The APK is uploaded as a workflow artifact.
